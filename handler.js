        ...
        case 'remove':
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    ...
                    let pp = 'https://telegra.ph/file/5d3462f6b8c6f5825c154.png'
                    let txw = `
                    ...
                    try {
                        ...
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || 'unknow') :
                            (chat.sBye || this.bye || conn.bye || 'Bye, @user!')).replace('@user', name)
let wel = `https://api.lolhuman.xyz/api/welcomeimage?apikey=tegar&img=${pp}&text= ⟦W⟧⟦E⟧⟦L⟧⟦C⟧⟦O⟧⟦M⟧⟦E⟧`

 let lea = `https://api.lolhuman.xyz/api/welcomeimage?apikey=tegar&img=${pp}&text= ⟦G⟧⟦O⟧⟦O⟧⟦D⟧⟦B⟧⟦Y⟧⟦E⟧ `
